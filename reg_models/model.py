...
data_dict = {
    ...
    'margin_2023': [
        66.1, 55.6, 80.9, 1508.6, -42.7, 42.3, 15.2, 12.5, 25.0, 639.3, 54.6, 
    ...
    'margin_2024': [
        49.9, 11.5, 122.2, 1580.3, -59.4, 24.1, 18.0, 15.0, 28.0, 479.5, 49.0, 
...
controls = ['investment_to_revenue_2023', 'ln_age'] + [col for col in data.columns if col.startswith('industry_')]
